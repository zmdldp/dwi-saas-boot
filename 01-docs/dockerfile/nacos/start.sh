...
docker stop saas_nacos
docker rm saas_nacos
docker run -idt --name saas_nacos --restart=always \
        ...
        -e MYSQL_SERVICE_HOST=192.168.2.178 -e MYSQL_SERVICE_DB_NAME=saas_nacos -e MYSQL_SERVICE_PORT=3218 \
