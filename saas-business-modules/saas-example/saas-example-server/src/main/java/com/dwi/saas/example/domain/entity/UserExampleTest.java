...
@AllArgsConstructor
public class UserExampleTest extends Entity<Long> {
    ...
    @Builder
    public UserExampleTest(Long id, Long createdBy, LocalDateTime createTime, Long updatedBy, LocalDateTime updateTime,
