...
public class SystemDatabaseAutoConfiguration extends BaseMasterDatabaseConfiguration {

    public SystemDatabaseAutoConfiguration(MybatisPlusProperties properties,
