...
@AllArgsConstructor
public class ResourceTest extends Entity<Long> {
    ...
    @Builder
    public ResourceTest(Long id, Long createdBy, LocalDateTime createTime, Long updatedBy, LocalDateTime updateTime,
