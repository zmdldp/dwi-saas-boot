...
//import com.dwi.saas.example.dto.RestTestDTO;
//import com.dwi.saas.example.entity.Order;
...
public class RestTemplateController implements DemoFeignApi{
    ...
    public R<String> upload(
        ...
        printHeader();
        IoUtil.copy(file.getInputStream(), new FileOutputStream("/Users/dwi/Downloads/uploadFiles/upload" + id + ".jpg"));
