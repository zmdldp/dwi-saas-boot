...
@AllArgsConstructor
public class OrgTest extends TreeEntity<OrgTest, Long> {
    ...
    @Builder
    public OrgTest(Long id, String label, Long parentId, Integer sortValue, LocalDateTime createTime, Long createdBy, LocalDateTime updateTime, Long updatedBy,
