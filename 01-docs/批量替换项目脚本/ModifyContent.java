...
public class ModifyContent {
    //这个路径不能含有dwi字符!!!!!!! 先将 dwi-commons-plus 修改为dwi-commons-plus
    //这个路径不能含有dwi字符!!!!!!! 先将 dwi-commons-plus 修改为dwi-commons-plus
    //这个路径不能含有dwi字符!!!!!!! 先将 dwi-commons-plus 修改为dwi-commons-plus
//    static String dir = "/Users/dwi/gitlab/test/dwi-commons-plus";// 文件所在路径，所有文件的根目录，记得修改为你电脑上的文件所在路径
    static String dir = "/Users/dwi/gitlab/test/dwi-cloud-plus";// 文件所在路径，所有文件的根目录，记得修改为你电脑上的文件所在路径
    static String newStr = "新的项目名";
    static String oldStr = "saas";
    ...
    public static void main(String[] args) {
        //这个路径不能含有dwi字符
        File f = new File(dir);
        print(f, 0, "/Users/dwi/gitlab/test", "/Users/dwi/gitlab/test/test3");
    }
