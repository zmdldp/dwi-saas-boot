...
@AllArgsConstructor
public class MenuTest extends TreeEntity<MenuTest, Long> {
    ...
    @Builder
    public MenuTest(Long id, String label, Integer sortValue, Long parentId, Long createdBy, LocalDateTime createTime, Long updatedBy, LocalDateTime updateTime,
