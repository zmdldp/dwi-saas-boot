...
//        map.put("date", DateUtils.formatAsDateTime(new Date()));
        ...
        String url = "http://saas-demo-server/restTemplate/get?key={key}";
//        String url = "http://saas-demo-server/restTemplate/get?key={key}&date={date}&ldt={ldt}";
...
//        HttpEntity httpEntity = new HttpEntity(map);
    ...
    public R<RestTestDTO> post(@RequestParam("key") String key) {
        ...
        String url = "http://saas-demo-server/restTemplate/post?key={key}";
    ...
    public R<RestTestDTO> post2(@RequestBody RestTestDTO order) {
        String url = "http://saas-demo-server/restTemplate/post2";
